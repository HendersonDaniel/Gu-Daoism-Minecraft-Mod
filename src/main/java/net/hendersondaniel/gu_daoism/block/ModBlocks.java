...
public class ModBlocks {
    ...
    public static final RegistryObject<LiquidBlock> PRIMEVAL_ESSENCE_FLUID_BLOCK = BLOCKS.register("soap_water_block",
            () -> new LiquidBlock(ModFluids.SOURCE_PRIMEVAL_ESSENCE_LIQUID, BlockBehaviour.Properties.copy(Blocks.WATER)));
